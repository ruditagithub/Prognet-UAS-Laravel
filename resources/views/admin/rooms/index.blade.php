...
@section('content')
    ...
    <header class="fixed top-0 left-0 right-0 z-50">
        <nav class="w-full flex justify-between items-center p-6 bg-[#451a03] text-white">
            ...
            <div class="md:hidden">
                <button id="menu-button-rooms" class="text-white focus:outline-none">
                    <i class="fas fa-bars"></i>
                </button>
            </div>
        </nav>
        <div id="mobile-menu-rooms" class="hidden md:hidden bg-[#451a03] text-white p-6">
            <ul class="space-y-4">
                <li><a class="hover:text-[#fcd34d]" href="{{ route('home') }}">Home</a></li>
                <li><a class="hover:text-[#fcd34d]" href="{{ route('home') }}#about">About</a></li>
                @guest
    ...
    <main class="container mx-auto p-5 mt-32">
    ...
    <script>
        ...
        // Toggle mobile menu
        document.getElementById('menu-button-rooms').addEventListener('click', function() {
            var mobileMenu = document.getElementById('mobile-menu-rooms');
